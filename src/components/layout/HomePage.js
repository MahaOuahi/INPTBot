...
<div>
    ...
    <nav class="nav-wrapper transparent fixed">
      <div class="container">
        ...
        <ul class="right hide-on-med-and-down">
          ...
          <li><a href="#faq" class="tooltipped btn-floating btn-small indigo " data-position="bottom" data-tooltip="FAQ"><i class="fa fa-question"></i></a></li>
          <li><a href="#campus" class="tooltipped btn-floating btn-small indigo " data-position="bottom" data-tooltip="Campus"><i class="fa fa-building"></i></a></li>
  ...
  <li>
       ...
       <div class="container section scrollspy" id="campus">
            <div class="row">
  ...
  <div class="parallax-container">
    ...
    <div class="section container scrollspy" id="faq">
      <div class="row">
        <div class="col s12 l4">
